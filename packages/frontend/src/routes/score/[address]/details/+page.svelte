<script lang="ts">
  ...
  const categorySignals: Record<ScoreCategory, Signal[]> = {
    ...
    governance: [
      ...
      { name: 'DAO Breadth', desc: '120 pts per DAO', cap: 360 },
      { name: 'Proposals Created', desc: '150 pts each', cap: 150 },
      { name: 'Delegation Events', desc: '30 pts each', cap: 90 },
      { name: 'Treasury Executions', desc: '60 pts each', cap: 120 },
      { name: 'Cross-chain Governance', desc: '50 pts per chain', cap: 150 },
      { name: 'Independent Voting', desc: '40 pts each (against/abstain)', cap: 120 },
      { name: 'Safe Multi-sig', desc: '50 pts per execution', cap: 200 },
      { name: 'Reasoned Votes', desc: '50 pts each', cap: 150 },
    ],
    temporal: [
      { name: 'Wallet Age', desc: '100 pts per year', cap: 400 },
      { name: 'Bear Market Activity', desc: '10 pts per tx in bear markets', cap: 300 },
      ...
      { name: 'Cross-cycle Persistence', desc: '150 pts per bear/bull cycle', cap: 300 },
    ],
    protocolDiversity: [
    ...
    complexity: [
      { name: 'Transaction Volume', desc: '3 pts each', cap: 300 },
      { name: 'Failed Tx Ratio', desc: 'Failure rate signal', cap: 300 },
      { name: 'Avg Calldata Size', desc: 'Based on calldata complexity', cap: 400 },
      { name: 'EIP-712 Permits', desc: '20 pts each', cap: 200 },
      { name: 'Flashloans', desc: '100 pts each', cap: 300 },
      { name: 'Smart Wallet Interactions', desc: '30 pts each', cap: 150 },
